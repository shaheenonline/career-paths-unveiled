  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" style={{background: 'linear-gradient(135deg, #1e293b 0%, #581c87 50%, #1e293b 100%)'}}>
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block px-4 py-2 rounded-full text-sm font-medium mb-6" style={{backgroundColor: '#9333EA22', color: '#9333EA', border: '1px solid #9333EA33'}}>
                Enterprise Suite
              </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl p-8 border" style={{borderColor: '#9333EA33'}}>
                <div className="grid grid-cols-3 gap-6 text-center mb-8">
                  <div className="p-4 rounded-lg" style={{backgroundColor: '#9333EA22'}}>
                    <div className="text-3xl font-bold" style={{color: '#9333EA'}}>98+</div>
                    <div className="text-sm text-gray-300">Countries Covered</div>
                  </div>
                  <div className="p-4 rounded-lg" style={{backgroundColor: '#3B82F622'}}>
                    <div className="text-3xl font-bold" style={{color: '#3B82F6'}}>3000+</div>
                    <div className="text-sm text-gray-300">In-demand Skills</div>
                  </div>
                  <div className="p-4 rounded-lg" style={{backgroundColor: '#9333EA22'}}>
                    <div className="text-3xl font-bold" style={{color: '#9333EA'}}>90+</div>
                ...
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    <Brain className="h-6 w-6 text-yellow-400 absolute -top-2 -right-2 animate-pulse" />
                  </div>
                </div>
              </div>
            </div>
              ...
              <CardHeader>
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center relative" style={{background: `linear-gradient(135deg, #9333EA 0%, #3B82F6 100%)`}}>
                    ...
                    <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{backgroundColor: '#9333EA'}}>1</div>
                  </div>
                </div>
                <CardTitle className="text-white text-xl">Comprehensive Solution Integration</CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardHeader>
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center relative" style={{background: `linear-gradient(135deg, #3B82F6 0%, #9333EA 100%)`}}>
                    ...
                    <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{backgroundColor: '#3B82F6'}}>2</div>
                  </div>
                </div>
                <CardTitle className="text-white text-xl">Precise Candidate Selection for Optimal Hiring</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400">
              ...
              <CardHeader>
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center relative" style={{background: `linear-gradient(135deg, #9333EA 0%, #3B82F6 100%)`}}>
                    ...
                    <div className="absolute -top-2 -right-2 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white" style={{backgroundColor: '#9333EA'}}>3</div>
                  </div>
                </div>
                <CardTitle className="text-white text-xl">Personalized Account Management</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">TrueFirms Enterprise</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              ...
              <CardHeader>
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-lg" style={{backgroundColor: '#9333EA33'}}>
                    <Globe className="h-6 w-6" style={{color: '#9333EA'}} />
                  </div>
                  <CardTitle className="text-white">Global On-Demand Talent Pool</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group" style={{borderColor: '#3B82F633'}}>
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-white">Efficient Onboarding</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 mb-4">
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group" style={{borderColor: '#9333EA33'}}>
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <CardTitle className="text-white">AI-Powered Platform</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-400 mb-4">
      ...
      <section className="py-20 px-4 bg-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Why businesses turn to TrueFirms</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="bg-slate-800/50 backdrop-blur-sm text-center p-8" style={{borderColor: '#9333EA33'}}>
              <Clock className="h-12 w-12 mx-auto mb-4" style={{color: '#9333EA'}} />
              <h3 className="text-xl font-bold text-white mb-2">Hire the talent you need in</h3>
              <div className="text-3xl font-bold" style={{color: '#9333EA'}}>3 DAYS, NOT 30</div>
            </Card>

            <Card className="bg-slate-800/50 backdrop-blur-sm text-center p-8" style={{borderColor: '#3B82F633'}}>
              <Trophy className="h-12 w-12 mx-auto mb-4" style={{color: '#3B82F6'}} />
              <h3 className="text-xl font-bold text-white mb-2">Trust experienced agencies</h3>
              <div className="text-3xl font-bold" style={{color: '#3B82F6'}}>SAVE 60-90%</div>
            </Card>

            <Card className="bg-slate-800/50 backdrop-blur-sm text-center p-8" style={{borderColor: '#9333EA33'}}>
              <BarChart3 className="h-12 w-12 mx-auto mb-4" style={{color: '#9333EA'}} />
              <h3 className="text-xl font-bold text-white mb-2">Deliver award-class work</h3>
              <div className="text-3xl font-bold" style={{color: '#9333EA'}}>4X FASTER</div>
            </Card>
          </div>

          <Card className="bg-slate-800/50 backdrop-blur-sm" style={{borderColor: '#9333EA33'}}>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-700">
                      ...
                      <th className="text-center py-4 text-white font-semibold">Traditional Process</th>
                      <th className="text-center py-4 font-semibold" style={{color: '#9333EA'}}>TrueFirms</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-300">
                    <tr className="border-b border-gray-800">
                      ...
                      <td className="py-4 text-center" style={{color: '#9333EA'}}>5,000+ Vendors</td>
                    </tr>
                    <tr className="border-b border-gray-800">
                      <td className="py-4 font-medium">Global Reach</td>
                      <td className="py-4 text-center">Geographical Limitations</td>
                      <td className="py-4 text-center" style={{color: '#9333EA'}}>98+ Countries</td>
                    </tr>
                    <tr className="border-b border-gray-800">
                      <td className="py-4 font-medium">Hiring Time</td>
                      <td className="py-4 text-center">30 Days</td>
                      <td className="py-4 text-center" style={{color: '#9333EA'}}>3-7 to 48 Hours</td>
                    </tr>
                    <tr className="border-b border-gray-800">
                      ...
                      <td className="py-4 text-center" style={{color: '#9333EA'}}>Negligible</td>
                    </tr>
                    <tr>
                      <td className="py-4 font-medium">Agility To Scale Team Up or Down</td>
                      <td className="py-4 text-center">Very Low</td>
                      <td className="py-4 text-center" style={{color: '#9333EA'}}>Very High</td>
                    </tr>
                  </tbody>
                </table>
              </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Insights by TrueFirms</h2>
            <p className="text-gray-400 text-lg">Stay updated with the latest trends and insights in talent acquisition</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group" style={{borderColor: '#9333EA33'}}>
              <CardContent className="p-6">
                ...
                <div className="text-sm" style={{color: '#9333EA'}}>September 5, 2024</div>
                <h3 className="text-lg font-semibold text-white mt-2 mb-3">Why TrueFirms Job Posting Feature is a Game Changer for Recruiters</h3>
                <p className="text-gray-400 text-sm mb-4">Finding the proper people for your project can be a difficult and time-consuming effort in the fast-paced corporate environment of...</p>
                <Button variant="outline" size="sm" style={{borderColor: '#9333EA', color: '#9333EA'}}>
                  Read More
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group" style={{borderColor: '#3B82F633'}}>
              <CardContent className="p-6">
                ...
                <div className="text-sm" style={{color: '#3B82F6'}}>July 15, 2024</div>
                <h3 className="text-lg font-semibold text-white mt-2 mb-3">What is an Employer of Record (EOR)? Benefits of Using TrueFirms EOR Services</h3>
                <p className="text-gray-400 text-sm mb-4">Expanding into new markets and getting foreign talent a simpler then ever in today's workplace company environment. However, understanding...</p>
                <Button variant="outline" size="sm" style={{borderColor: '#3B82F6', color: '#3B82F6'}}>
                  Read More
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 group" style={{borderColor: '#9333EA33'}}>
              <CardContent className="p-6">
                ...
                <div className="text-sm" style={{color: '#9333EA'}}>June 10, 2024</div>
                <h3 className="text-lg font-semibold text-white mt-2 mb-3">The Future of Managed IT Services: Trends to Watch Out For</h3>
                <p className="text-gray-400 text-sm mb-4">Managed IT services have become vital in an ever-changing digital market for businesses seeking to remain competitive and optimize...</p>
                <Button variant="outline" size="sm" style={{borderColor: '#9333EA', color: '#9333EA'}}>
                  Read More
                </Button>
              </CardContent>
